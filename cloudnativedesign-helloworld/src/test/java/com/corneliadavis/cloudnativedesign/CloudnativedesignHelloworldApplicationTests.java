...
public class CloudnativedesignHelloworldApplicationTests {
    ...
    public void	helloValidToken() throws Exception {
        assertFalse(CloudnativedesignHelloworldApplication.validTokens.isEmpty());

        String validToken = CloudnativedesignHelloworldApplication.validTokens.keySet().iterator().next();
        String validName = CloudnativedesignHelloworldApplication.validTokens.get(validToken);
